...
const Perssona = [
    { nome: 'dasdas', indirizzo: 'v ss' }
{ nome: 'asd', indirizzo: 'v sdsdfdsf' }
{ nome: 'dsaasd', indirizzo: 'v  sdsf' }
{ nome: 'afs', indirizzo: 'vdsd' }
{ nome: 'xcv', indirizzo: 'v  sdsf' }
]
...
const altro = {
    ...
    v ss',
        	555	sd
asd	v sdsdfdsf	33	dsd
dsaasd	v  sdsf	222	das
afs	vdsd	111	asd
xcv	v  sdsf	333	asd
xcxcv	v dfsdf	444	asd
}